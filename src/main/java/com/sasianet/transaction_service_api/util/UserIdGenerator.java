...
public class UserIdGenerator extends SequenceStyleGenerator {
    ...
    public static final String DATE_FORMAT_DEFAULT = "%1$tY%1$tm";//"%tY%tm";
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) throws HibernateException {
        //return valuePrefix + dateNumberSeparator+String.format(numberFormat, super.generate(session, object));
        return valuePrefix+String.format(dateFormat, LocalDate.now(), super.generate(session, object))+dateNumberSeparator+String.format(numberFormat, super.generate(session, object));
    }
   ...
   /* public static final String VALUE_PREFIX_PARAMETER = "valuePrefix";
    //public static final String VALUE_PREFIX_DEFAULT = "JE";
    public static final String VALUE_PREFIX_DEFAULT = "";
